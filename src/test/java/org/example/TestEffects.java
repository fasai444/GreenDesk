...
public class TestEffects {
    ...
    public void testEffectImpactOnStress() throws Exception {
        ...
        plant = plantRepository.findById(Objects.requireNonNull(plant.getId())).orElseThrow();
    ...
    public void testFertilizerEffectOnGrowth() throws Exception {
        ...
        plantWithoutEffect = plantRepository.findById(Objects.requireNonNull(plantWithoutEffect.getId())).orElseThrow();
        plantWithEffect = plantRepository.findById(Objects.requireNonNull(plantWithEffect.getId())).orElseThrow();
