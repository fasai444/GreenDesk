...
public class EcosystemCell {
    ...
    public List<EcosystemCell> getNeighbors(org.example.entities.ecosystem.Ecosystem ecosystem) {
    ...
    public PlantDisease getMostSevereNeighborDisease(org.example.entities.ecosystem.Ecosystem ecosystem) {
    ...
    public boolean shouldBecomeInfected(org.example.entities.ecosystem.Ecosystem ecosystem, double threshold) {
        if (!hasPlant()) {
            return false;
        }
        if (isDiseased()) {
    ...
    public boolean shouldRecover(org.example.entities.ecosystem.Ecosystem ecosystem, double threshold) {
