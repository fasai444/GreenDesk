...
public interface PlantRepository extends MongoRepository<Plant, String> {
    ...
    /**
     * Recherche partielle sur le nom de la plante (ex: "Tomato" trouve "Tomato_Plant_1")
     ...
     * Utile quand on clique sur une espèce dans la page "Species" pour voir ses plantes.
     */
